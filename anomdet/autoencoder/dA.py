...
th
    ...
    def fit(self, X, y=None, **kwargs):
        ...
        cost, updates = self.get_cost_updates(corruption_level=self.corruption_level,
...
if __name__ == '__main__':
    ...
    da = dA(rng, theano_rng, n_visible=27, n_hidden=100).fit(X, batch_size=20, training_epochs=2)
    autoenc_confidence = da.predict(X)
    print roc_auc_score(y, autoenc_confidence)
    print "OK"